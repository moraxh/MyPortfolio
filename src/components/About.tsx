...
export default function About() {
  ...
  const stats = [
    ...
    { label: "Projects Completed", value: "35+", icon: <Code className="w-6 h-6 text-purple-400" /> },
    { label: "Technologies Mastered", value: "20+", icon: <Target className="w-6 h-6 text-emerald-400" /> },
    { label: "Organizations Served", value: "4+", icon: <Heart className="w-6 h-6 text-pink-400" /> }
  ]
