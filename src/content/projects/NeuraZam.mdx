...
thumbnail: NeuraZam/thumbnail.png
---
...
![Augmenting Data](../../assets/ProjectsImages/NeuraZam/augmenting_songs.png)

### Server State (Training Model)
![Training Model](../../assets/ProjectsImages/NeuraZam/training.png)

### Frontend
![Frontend](../../assets/ProjectsImages/NeuraZam/frontend.png)

### Model Predicting
![Frontend](../../assets/ProjectsImages/NeuraZam/prediction.png)
